    ...
    <div className="min-h-screen py-16 bg-[#FAF9F5] text-gray-800 relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 pt-10">
          <Link href="/patrocinadores" className="inline-flex items-center space-x-2 text-xs font-semibold uppercase tracking-widest text-brand-gold hover:underline transition-colors">
        ...
        <div className="bg-white border border-brand-gold/20 p-8 mb-12 shadow-sm">
