    ...
    <div className="min-h-screen py-16 bg-brand-bg relative">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8 text-sm sm:text-base text-gray-400 font-light leading-relaxed">
          <p>
            En **CINEFONÍA Nights**, nos tomamos muy en serio la privacidad y seguridad de los datos personales de nuestros usuarios, espectadores y patrocinadores. Esta política describe cómo recopilamos, usamos y protegemos la información personal compartida con nosotros a través de este portal web.
          </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>**Formulario de Patrocinio:** Recopilamos el nombre de la empresa, el nombre del representante, correo corporativo, teléfono y detalles de la propuesta de alianza.</li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p>
              Tienes el derecho de acceder, rectificar, cancelar u oponerte al tratamiento de tus datos personales. Para ejercer estos derechos, puedes remitir una solicitud formal al correo electrónico oficial: **contacto@cinefonia-nights.pe**, adjuntando la información correspondiente para validar tu identidad.
            </p>
          </div>
        </div>
